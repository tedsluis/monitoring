...
0 0,8,16 * * * cd /${HOME}/git/monitoring && ./renovate.sh >> /${HOME}/git/monitoring/logs/renovate-cron.log 2>&1
0 1,7,17 * * * cd /${HOME}/git/monitoring && ./poll-renovate-prs.sh >> /${HOME}/git/monitoring/logs/poll-renovate-prs-cron.log 2>&1
