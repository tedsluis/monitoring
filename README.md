...
----------------------------------------
🔍 [TEST] Proxy: Alloy
✅ [SUCCESS] alloy.monitoring.home is reachable.
----------------------------------------
🔍 [TEST] Proxy: Alertmanager
✅ [SUCCESS] alertmanager.monitoring.home is reachable.
----------------------------------------
🔍 [TEST] Proxy: Grafana
✅ [SUCCESS] grafana.monitoring.home is reachable.
----------------------------------------
🔍 [TEST] Proxy: Karma
✅ [SUCCESS] karma.monitoring.home is reachable.
----------------------------------------
🔍 [TEST] Proxy: KeepHQ (Frontend)
✅ [SUCCESS] keep.monitoring.home is reachable.
----------------------------------------
🔍 [TEST] Proxy: MinIO Console
✅ [SUCCESS] minio.monitoring.home is reachable.
----------------------------------------
🔍 [TEST] Proxy: Traefik Dashboard
✅ [SUCCESS] traefik.monitoring.home is reachable.
----------------------------------------
🔍 [TEST] Proxy: Webhook Tester
✅ [SUCCESS] webhook-tester.monitoring.home is reachable.
========================================
